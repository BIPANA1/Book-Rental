...
<div class="row justify-content-center"  style="margin-top:10%">
    <div class="col-md-12">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="{{route('rent.update',['id' =>$rent->id])}}">
                    @csrf
                    @method('POST')
                    <div class="row mb-3">
                        <label for="text"
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-8">
                            <input id="code" type="text"
                                ...
                                value="{{$rent->code}}" required autocomplete="code" autofocus>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-8">
                            <input id="number_of_days" type="number"
                                ...
                                value="{{$rent->number_of_days}}" required autocomplete="number_of_days" autofocus>
